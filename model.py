...
class SimpleCNN(nn.Module):
    ...
    当输入分辨率为31时，全局平均池化等效于被忽略.
    可以通过修改各层的 self.conv_1_channels、self.conv_2_channels、self.conv_3_channels 参数调整整个网络的参数量、运算量
    """
    ...
    def __init__(self, input_channels: int = 3, num_classes: int = 10):
        ...
        self.conv_1 = nn.Conv2d(
            input_channels, self.conv_1_channels, kernel_size=3, stride=2
        )
        ...
        self.conv_4_channels = num_classes
